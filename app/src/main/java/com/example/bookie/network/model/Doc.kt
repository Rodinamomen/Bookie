...
data class Doc(
    ...
    val id_bibliothèque_nationale_de_france_bnf: List<String>,
    ...
    val id_etsc: List<String>,
    val id_freebase: List<String>,
    val id_goodreads: List<String>,
    val id_google: List<String>,
    val id_hathi_trust: List<String>,
    val id_isfdb: List<String>,
    val id_issn: List<String>,
    val id_librarything: List<String>,
    val id_libris: List<String>,
    val id_librivox: List<String>,
    val id_lulu: List<String>,
